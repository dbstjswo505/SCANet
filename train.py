...
def parse_args():
    ...
    parser.add_argument('--config-path', type=str, default='config/activitynet/main.json', help='config file path')
    parser.add_argument('--resume', type=str, default=None, help='checkpoint path to resume')
    parser.add_argument('--eval', action='store_true', help='only evaluate')
    parser.add_argument('--log_dir', default='./logs', type=str, help='log file save path')
    parser.add_argument('--tag', default='dbg', type=str, help='experiment tag')
